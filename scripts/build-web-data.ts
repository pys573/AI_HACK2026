...
export type SiteBlock = {
   ...
   * 그런데 손에 있는 트레이스 367건 중 error 35건은 전부 우리 쪽 사정이었다 —
   * OrcaRouter 잔액 소진 20 / 미션에 정답 키 없음 8(옛 세대) / 화면이미지 입력 미지원 6 / 브라우저 닫힘 1.
   * 이 중 공표 집계(batchv2·공표 5프로필)에 들어 있던 것은 18건이다 (2026-08-13 재집계).
